...
class UserService {
    ...
    async signIn(email, plainPassword) {
        try {
            //step 1->fetch the user using the email(from repository layer)
    ...
    async isAuthenticated(token) {
     ...
     checkPassword(userInputPlainPassword, encryptedPassword) {//->this encrypted password ,we will get from the repository layer
        try {
